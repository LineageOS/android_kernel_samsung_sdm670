...
enum {
	...
	PRODUCT_NUM_ASTAR_DREAMLITE = 0x0B,
	PRODUCT_NUM_KELLY = 0x0C,
	PRODUCT_NUM_GTS4 = 0x0D, /* Actually prodcut num of tablet models is 0x0D */
	PRODUCT_NUM_A8S = 0x11,
	PRODUCT_NUM_TABS4LV = 0x12,
};
