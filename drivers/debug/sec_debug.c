...
static const struct kernel_param_ops alloc_virtual_mem_ops = {
	.set = sec_alloc_virtual_mem,
	.get = NULL,
};
module_param_cb(alloc_virtual_mem, &alloc_virtual_mem_ops, NULL, 0644);
...
static const struct kernel_param_ops sec_free_virtual_mem_ops = {
	.set = sec_free_virtual_mem,
	.get = NULL,
};
module_param_cb(free_virtual_mem, &sec_free_virtual_mem_ops, NULL, 0644);
...
static const struct kernel_param_ops sec_alloc_physical_mem_ops = {
	.set = sec_alloc_physical_mem,
	.get = NULL,
};
module_param_cb(alloc_physical_mem, &sec_alloc_physical_mem_ops, NULL, 0644);
...
static const struct kernel_param_ops sec_free_physical_mem_ops = {
	.set = sec_free_physical_mem,
	.get = NULL,
};
module_param_cb(free_physical_mem, &sec_free_physical_mem_ops, NULL, 0644);
...
static const struct kernel_param_ops dbg_set_cpu_affinity_ops = {
	.set = dbg_set_cpu_affinity,
	.get = NULL,
};
module_param_cb(setcpuaff, &dbg_set_cpu_affinity_ops, NULL, 0644);
...
EXPORT_SYMBOL(sec_debug_get_upload_cause);
...
#define MAX_STR_LEN 80
	...
	struct __upload_cause {
		...
		{ "cachecoherency_test", UPLOAD_CAUSE_QUEST_CACHECOHERENCY,
			SEC_STRNCMP },
		...
		{ "qmesa_ddr_test_cache_centric", UPLOAD_CAUSE_QUEST_QMESACACHE,
			SEC_STRNCMP },
