 ...
 *
*/
#include "ss_dsi_mdnie_NT36672A_B6P064YQ5LP.h"
#include "ss_dsi_panel_NT36672A_B6P064YQ5LP.h"
...
static void backlight_tft_late_on(struct samsung_display_driver_data *vdd)
{
	 ...
	 * display_on(29h) be sent.
	 */
	msleep(40);
	LCD_INFO("re-conf bl_level=%d\n", vdd->br.bl_level);
...
static int __init samsung_panel_initialize(void)
{
	...
	char panel_string[] = "ss_dsi_panel_NT36672A_B6P064YQ5LP_FHD";
