...
#if defined (CONFIG_PANEL_S6E3HA9_AMB611WE01_WQHD) || defined (CONFIG_PANEL_S6E3HA9_AMB644WF01_WQHD)
	hmt_enable(vdd);
...
#if defined (CONFIG_PANEL_S6E3HA9_AMB597RT01_WQHD) || defined (CONFIG_PANEL_S6E3XA0_AMB729WA01_QXGA)
	return size;
#endif
