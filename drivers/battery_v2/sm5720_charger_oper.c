...
static struct sm5720_charger_oper_table_info sm5720_charger_operation_mode_table[] = {
	...
	{make_OP_STATUS(0, 0, 0, 0, 0, 0, 0), SM5720_CHARGER_OP_MODE_CHG_ON_VBUS,
							BSTOUT_5200mV, OTG_CURRENT_500mA, TX_CURRENT_500mA},
	{make_OP_STATUS(1, 0, 0, 0, 0, 0, 0), SM5720_CHARGER_OP_MODE_CHG_ON_VBUS,
							BSTOUT_5200mV, OTG_CURRENT_500mA, TX_CURRENT_500mA},
	{make_OP_STATUS(1, 0, 1, 0, 0, 0, 0), SM5720_CHARGER_OP_MODE_CHG_ON_VBUS,
							BSTOUT_5200mV, OTG_CURRENT_1500mA, TX_CURRENT_500mA},
	/* Charger=ON Mode over WPCIN */
	{make_OP_STATUS(0, 1, 0, 0, 0, 0, 0), SM5720_CHARGER_OP_MODE_CHG_ON_WPCIN,
							BSTOUT_5200mV, OTG_CURRENT_500mA, TX_CURRENT_500mA},
	/* TX Mode in a valid VBUS */
	{make_OP_STATUS(1, 0, 0, 0, 1, 0, 0), SM5720_CHARGER_OP_MODE_TX_MODE_VBUS,
							BSTOUT_5200mV, OTG_CURRENT_500mA, TX_CURRENT_500mA},
	{make_OP_STATUS(1, 0, 0, 0, 0, 1, 0), SM5720_CHARGER_OP_MODE_TX_MODE_VBUS,
							BSTOUT_9000mV, OTG_CURRENT_500mA, TX_CURRENT_500mA},
	/* Wireless OTG Mode and Charger=ON */
	{make_OP_STATUS(0, 1, 1, 0, 0, 0, 0), SM5720_CHARGER_OP_MODE_WPC_OTG_CHG_ON,
							BSTOUT_5200mV, OTG_CURRENT_1500mA, TX_CURRENT_500mA},
	{make_OP_STATUS(0, 1, 0, 1, 0, 0, 0), SM5720_CHARGER_OP_MODE_WPC_OTG_CHG_ON,
							BSTOUT_5200mV, OTG_CURRENT_500mA, TX_CURRENT_500mA},
	/* USB OTG Mode */
	{make_OP_STATUS(0, 0, 1, 0, 0, 0, 0), SM5720_CHARGER_OP_MODE_USB_OTG,
							BSTOUT_5200mV, OTG_CURRENT_1500mA, TX_CURRENT_500mA},
	{make_OP_STATUS(0, 0, 0, 1, 0, 0, 0), SM5720_CHARGER_OP_MODE_USB_OTG,
							BSTOUT_5200mV, OTG_CURRENT_500mA, TX_CURRENT_500mA},
	/* USB OTG and TX Mode */
	{make_OP_STATUS(0, 0, 1, 0, 1, 0, 0), SM5720_CHARGER_OP_MODE_USB_OTG_TX_MODE,
							BSTOUT_5200mV, OTG_CURRENT_1500mA, TX_CURRENT_500mA},
	{make_OP_STATUS(0, 0, 0, 1, 1, 0, 0), SM5720_CHARGER_OP_MODE_USB_OTG_TX_MODE,
							BSTOUT_5200mV, OTG_CURRENT_500mA, TX_CURRENT_500mA},
	/* TX Mode in NO valid VBUS */
	{make_OP_STATUS(0, 0, 0, 0, 1, 0, 0), SM5720_CHARGER_OP_MODE_TX_MODE_NOVBUS,
							BSTOUT_5200mV, OTG_CURRENT_500mA, TX_CURRENT_500mA},
	{make_OP_STATUS(0, 0, 0, 0, 0, 1, 0), SM5720_CHARGER_OP_MODE_TX_MODE_NOVBUS,
							BSTOUT_9000mV, OTG_CURRENT_500mA, TX_CURRENT_500mA},
	/* Suspend Mode */
	{make_OP_STATUS(0, 0, 0, 0, 0, 0, 1), SM5720_CHARGER_OP_MODE_SUSPEND,
							BSTOUT_5200mV, OTG_CURRENT_500mA, TX_CURRENT_500mA},
							/* Reserved */
};
...
int sm5720_charger_oper_get_cv_batreg(void)
{
    ...
    sm5720_read_reg(oper_info.i2c, SM5720_CHG_REG_MODESTATUS, &reg);
    cv_mode = reg & 0x1;

    sm5720_read_reg(oper_info.i2c, SM5720_CHG_REG_CHGCNTL4, &reg);
    BATREG = ((((reg & 0x3F) - 2) * 10) + 4010);

    pr_info("sm5720-charger: %s: CV_MODE=%d, BATREG=%dmV\n", __func__, cv_mode, BATREG);

	return (BATREG + cv_mode);
}
EXPORT_SYMBOL(sm5720_charger_oper_get_cv_batreg);
